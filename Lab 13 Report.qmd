...
Disclaimer: All of the following codes were created by Ai. This was an exericse in trying to come up with prompts / follow-up questions.
...
Like the graph above, an NMDS analysis was run to display where the dominant species *are what*.
